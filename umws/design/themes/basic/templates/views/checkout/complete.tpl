<div class="row">
    <div class="span16 order-placed-successfully">
...
<div class="span8">
    ...
    <div class="order-create-account form-wrap login">
...
{/if}
    ...
    <div class="span16 buttons-container wrap {if !$order_info || !$settings.General.allow_create_account_after_order == "Y" || $auth.user_id} margin-top{/if}">

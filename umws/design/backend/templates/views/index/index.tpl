...
{if $show_welcome}
    <div class="hidden cm-dialog-auto-open cm-dialog-auto-size" title="{__("installer_complete_title")}" id="after_install_dialog">
        ...
        <p>
            {__("installer_complete_thank_you", ['[product_name]' => $product_name])}
        </p>

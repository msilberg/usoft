                        ...
                        //<![CDATA[
                            (function(_, $) {
                                $(document).ready(function() {
                                    if ($('.form-inline input[type=radio]:checked').length > 0) {
                                        $('.form-inline input[type=radio]:checked').each(function() {
                                            $(this).closest('.form-inline').find('.disable-overlay').hide();
                                        });
                                    }
                                    $('.form-inline input[type=radio]').on('click', function() {

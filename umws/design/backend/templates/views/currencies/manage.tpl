...
{capture name="mainbox"}
    ...
    <div class="items-container cm-sortable {if !""|fn_allow_save_object:"":true} cm-hide-inputs{/if}"
         data-ca-sortable-table="currencies" data-ca-sortable-id-name="currency_code" id="manage_currencies_list">
        {if $currencies_data}
...
{include file="common/mainbox.tpl" title=__("currencies") content=$smarty.capture.mainbox sidebar=$smarty.capture.sidebar select_languages=true adv_buttons=$smarty.capture.adv_buttons}

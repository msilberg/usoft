<?php /* Smarty version Smarty-3.1.13, created on 2013-10-22 14:34:13
         compiled from "/home/mike/public_html/umws/design/backend/templates/menu.tpl" */ ?>
<?php /*%%SmartyHeaderCode:492071373526654a54ad1e7-18698113%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ad124f5e5cd40cb3513dd5b45267ff889852bb7d' => 
    array (
      0 => '/home/mike/public_html/umws/design/backend/templates/menu.tpl',
      1 => 1380199120,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '492071373526654a54ad1e7-18698113',
  'function' => 
  array (
    'menu_attrs' => 
    array (
  ...
  'unifunc' => 'content_526654a5789a90_49837177',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_526654a5789a90_49837177')) {function content_526654a5789a90_49837177($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/home/mike/public_html/umws/app/functions/smarty_plugins/modifier.truncate.php';
...
<?php if (defined("THEMES_PANEL")){?>
    <?php $_smarty_tpl->tpl_vars['sticky_scroll'] = new Smarty_variable(81, null, 0);?>
<?php }else{ ?>
...
<div class="navbar-admin-top">
    ...
    <div class="navbar navbar-inverse" id="header_navbar">
        ...
        <?php if ($_smarty_tpl->tpl_vars['settings']->value['Company']['company_name']){?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['auth']->value['user_id']){?>
                ...
                <?php if (!fn_allowed_for("ULTIMATE:FREE")){?>
                    <?php if (sizeof($_smarty_tpl->tpl_vars['languages']->value)>1){?>
                        <?php echo $_smarty_tpl->getSubTemplate ("common/select_object.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('style'=>"dropdown",'link_tpl'=>fn_link_attach($_smarty_tpl->tpl_vars['config']->value['current_url'],"sl="),'items'=>$_smarty_tpl->tpl_vars['languages']->value,'selected_id'=>@constant('CART_LANGUAGE'),'display_icons'=>true,'key_name'=>"name",'key_selected'=>"lang_code",'class'=>"languages"), 0);?>
                ...
                <?php echo $_smarty_tpl->getSubTemplate ("common/select_object.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('style'=>"dropdown",'link_tpl'=>fn_link_attach($_smarty_tpl->tpl_vars['config']->value['current_url'],"currency="),'items'=>$_smarty_tpl->tpl_vars['currencies']->value,'selected_id'=>$_smarty_tpl->tpl_vars['secondary_currency']->value,'display_icons'=>false,'key_name'=>"description",'key_selected'=>"currency_code"), 0);?>

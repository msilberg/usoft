...
class F306T401
{
    ...
    public function import($db_already_cloned)
    {
        ...
        General::uninstallAddons(array('twigmo', 'searchanise', 'live_help', 'exim_store'));
    ...
    protected function _convertOrders()
    {
        ...
        for ($i = 0; $i <= floor($orders_count / $limit); $i++) {
            ...
            $data = array();
            fn_set_progress('echo', '<br />' . __('store_import.converting_orders'), true);
    ...
    protected function _installSuppliers()
    {
        ...
        $langvars = array(
            ...
            'en' => array(
                'search_by_supllier' => 'Search by supplier',
                'supllier' => 'Supplier',

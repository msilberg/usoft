...
function fn_facebook_prepare_settings($facebook_settings, $params)
{
    ...
    if ($params['object'] == 'products') {
        $data_href = fn_url('products.view?product_id=' . $params['object_id'] . '&lang_code=' . $params['lang_code'] . (!empty($_SESSION['init_context']) ? '#!' . $_SESSION['init_context'] : ''));
    } elseif ($params['object'] == 'pages') {
        $data_href = fn_url('pages.view?page_id=' . $params['object_id'] . '&lang_code=' . $params['lang_code'] . (!empty($_SESSION['init_context']) ? '#!' . $_SESSION['init_context'] : ''));
    }

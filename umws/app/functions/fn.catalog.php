...
function fn_get_products($params, $items_per_page = 0, $lang_code = CART_LANGUAGE)
{
    ...
    $categories_filter_join = " INNER JOIN ?:products_categories as products_categories_filter ON products_categories_filter.product_id = products.product_id INNER JOIN ?:categories AS categories_filter ON categories_filter.category_id = products_categories_filter.category_id $category_filter_avail_cond ";

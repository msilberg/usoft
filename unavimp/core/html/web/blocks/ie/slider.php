...
?>
<div class="list-slider list-slider-<?php print $wdir.$arr['lsbva'] ?>" id="<?php print $arr['sid'] ?>">
		...
		<tr>
			...
			<?php
				if ($arr['num']>$arr['dvd'])
				{
					...
					print (($crit)?"<table cellspacing=\"0\" cellpadding=\"0\"><tr><td><div id=\"beg\" class=\"ls-move ls-move-beg ls-move-act\">&larr;</div></td>
						<td><div class=\"ls-btn-scope\"><div class=\"ls-btn-cont\">":NULL)."<table cellspacing=\"0\" cellpadding=\"0\"><tr>";
					for ($i=1;$i<=$_SESSION['slides_num'];$i++) print "<td><div class=\"ls-btn lsbtn-".$arr['sid']." ls-btn-".(($i==1)?"act":"pass")."\">$i</div></td>";
					print "</tr></table>".(($crit)?"</div></div></td>
						<td><div id=\"end\" class=\"ls-move ls-move-end ls-move-pass\">&rarr;</div></td></tr></table>":NULL);
				}
				else
				{

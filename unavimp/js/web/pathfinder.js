var pathfinder = {
    ...
    , sources: {
        ...
        , car: {
            ...
            1: ['ул. Елены Стасовой', 36.297653087069, 49.999890476089]
            , 2: ['пер. Весенний', 36.299917529642, 50.001260324065]
        }
        , bus: {
            1: ['ул. Елены Стасовой', 36.297653087069, 49.999890476089]
            , 2: ['пер. Весенний', 36.299917529642, 50.001260324065]
        ...
        , tram: {
            1: ['ул. Якира', 36.304398658669, 49.99984854197]
            , 2: ['ул. Амурская', 36.308321828723, 50.003678525088]
            , 3: ['възд Тевелева', 36.312095899678, 50.007364068452]
        }
        , metro: {
            1: ['Северо-западный выход', 36.3016323552, 50.0047952678]
            , 2: ['Северо-восточный выход', 36.30432759707, 50.004955186125]
            , 3: ['Юго-западный выход', 36.301760296952, 50.003664547046]
            , 4: ['Юго-восточный выход', 36.304519801687, 50.003128722158]
        }
    }
